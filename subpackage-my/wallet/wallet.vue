	...
	<view class="page">
		...
		<view class="ellipse px-3">
			<view class="wallet-card px-4 pt-4 pb-1">
				<view class="d-flex a-center">
					<image src="../../static/images/wallet2.png" mode="heightFix" style="height: 35rpx;"></image>
		...
		<view class="d-flex j-sb  mx-3 wallet-operation" style="margin-top: 80rpx;">
			<view class="p-2 recharge">
				...
				<image src="https://oss-augustrush.oss-cn-shenzhen.aliyuncs.com/yayiImage/wallet3.png" mode="heightFix" class="img"></image>
			</view>
			<view class="p-2 withdrawal">
				...
				<image src="https://oss-augustrush.oss-cn-shenzhen.aliyuncs.com/yayiImage/money.png" mode="heightFix" class="img"></image>
			</view>
		</view>

		<view class="mx-3 mt-4 mb-2">
			<uni-card is-full spacing="5px"><view class="border-bottom font-md font-weight pb-2">资金明细</view>
			...
			<view class="detail d-flex j-sb py-2">
				...
				<view>
				<view class="font-md font-weight" style="text-align: end;">
					{{item.reducedAmount}}
				</view>
				<view class="text-light-muted" style="padding-top: 5rpx;font-size: 24upx;">
...
.page {
	...
	.ellipse {
		...
		.wallet-card {
			...
			box-shadow: 6rpx 6rpx 20rpx #7ed1ce;
			width: 690rpx;
			border-radius: 15rpx;
		}
	}
	...
	.recharge {
		...
		width: 320rpx;
		border-radius: 20rpx;
		background: linear-gradient(to right, #21b0ab, #21b0ab);
		box-shadow: 0rpx 0rpx 8rpx 2rpx #44bcb8;
		.toRecharge {
